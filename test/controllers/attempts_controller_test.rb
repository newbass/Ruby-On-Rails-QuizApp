...
class AttemptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attempt" do
    assert_difference('Attempt.count') do
      post attempts_url, params: { attempt: { qid: @attempt.qid, state: @attempt.state, success: @attempt.success, uid: @attempt.uid } }
    end
  ...
  test "should update attempt" do
    patch attempt_url(@attempt), params: { attempt: { qid: @attempt.qid, state: @attempt.state, success: @attempt.success, uid: @attempt.uid } }
